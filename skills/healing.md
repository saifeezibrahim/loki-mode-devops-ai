...
|--------|-----------------|----------|
| Amazon AGI Lab (2026) | Friction-as-semantics, agents as universal API over legacy UIs | [amazon.science blog](https://www.amazon.science/blog/REDACTED) |
...
| AWS Transform (2025-2026) | Decomposition agents, semantic seeding, domain grouping | [AWS blog](https://aws.amazon.com/blogs/migration-and-modernization/REDACTED/) |
| GitHub Copilot (2025) | 3-agent pattern: extract logic, generate tests, generate modern code | [github.blog](https://github.blog/ai-and-ml/github-copilot/REDACTED/) |
...
decomposition_agents:
  ...
  github_3_agent:
    ...
    source: "github.blog/ai-and-ml/github-copilot/REDACTED/"
```
