...
| `REDACTED` | Umbrella for multiagent session path | RESEARCH PREVIEW |
| `REDACTED` | Managed code-review council via `callable_agents` | RESEARCH PREVIEW |
| `REDACTED` | Managed completion council via `callable_agents` | RESEARCH PREVIEW |
