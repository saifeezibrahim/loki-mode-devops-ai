...
|----------------|---------------------------|
| [Constitutional AI: Harmlessness from AI Feedback](https://www.anthropic.com/research/REDACTED) | Self-critique against principles, revision workflow |
...
| [Sabotage Evaluations](https://www.anthropic.com/research/REDACTED) | Safety evaluation methodology |
| [Effective Harnesses for Long-Running Agents](https://www.anthropic.com/engineering/REDACTED) | One-feature-at-a-time pattern, Playwright MCP for E2E |
...
| Paper/Resource | Contribution to Loki Mode |
|----------------|---------------------------|
| [SIMA 2: Generalist AI Agent](https://deepmind.google/blog/REDACTED/) | Self-improvement loop, reward model training |
| [Gemini Robotics 1.5](https://deepmind.google/blog/REDACTED/) | Hierarchical reasoning (planner + executor) |
| [Dreamer 4: World Model Training](https://danijar.com/project/dreamer4/) | Simulation-first testing, safe exploration |
| [Genie 3: World Models](https://deepmind.google/blog/REDACTED/) | World model architecture patterns |
...
| [Human-AI Complementarity for Amplified Oversight](https://deepmindsafetyresearch.medium.com/REDACTED) | AI-assisted human supervision |
...
| [A Practical Guide to Building Agents](https://cdn.openai.com/business-guides-and-resources/REDACTED.pdf) | Agent architecture best practices |
...
| Paper/Resource | Contribution to Loki Mode |
|----------------|---------------------------|
| [Multi-Agent Orchestration Guidance](https://aws.amazon.com/solutions/guidance/REDACTED/) | Three coordination mechanisms, architectural patterns |
| [Bedrock Multi-Agent Collaboration](https://docs.aws.amazon.com/bedrock/latest/userguide/REDACTED.html) | Supervisor mode, routing mode, 10-agent limit |
| [Multi-Agent Collaboration Announcement](https://aws.amazon.com/blogs/aws/REDACTED/) | Intent classification, selective context sharing |
| [AgentCore for SRE](https://aws.amazon.com/blogs/machine-learning/REDACTED/) | Gateway, Memory, Identity, Observability components |
...
| Resource | Contribution |
|----------|--------------|
| [Maxim AI: Production Multi-Agent Systems](https://www.getmaxim.ai/articles/REDACTED/) | Correlation IDs, failure handling |
...
| Resource | Contribution |
|----------|--------------|
| [Claude Code Git Worktrees](https://code.claude.com/docs/en/common-workflows#REDACTED) | Parallel Claude sessions, worktree isolation pattern |
...
| Resource | Contribution |
|----------|--------------|
| [Google A2A Protocol](https://developers.googleblog.com/en/REDACTED/) | Agent Cards, capability discovery, JSON-RPC 2.0 |
| [A2A Protocol v0.3](https://cloud.google.com/blog/products/ai-machine-learning/REDACTED) | gRPC support, security card signing, enterprise features |
