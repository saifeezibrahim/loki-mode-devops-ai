...
- [Anthropic: Anthropic acquires Bun as Claude Code reaches $1B milestone](https://www.anthropic.com/news/REDACTED)
...
4. **Three-runtime codebase** is real cognitive overhead for new . Mitigation: clear `CONTRIBUTING.md` table of "what runtime owns what."
